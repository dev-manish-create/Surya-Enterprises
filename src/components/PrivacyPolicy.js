    ...
    return (
        <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
            ...
            <ul>
                ...
                <li>
                    <strong>Company:</strong> Refers to Surya Enterprises, 16/212 Trilok
                    Puri, New Delhi-110091.
                </li>
                <li>
                    <strong>Cookies:</strong> Small files that are placed on Your computer
                    or device by a website to store browsing details.
                </li>
                <li>
                    <strong>Service:</strong> Refers to the Website.
                </li>
                <li>
                    <strong>Website:</strong> Surya Enterprises, accessible from{" "}
                    <a href="https://www.suryaenterprisses.com">
                        www.suryaenterprisses.com
                    </a>
                    .
                </li>
                <li>
            ...
            <p>
                ...
                <b>•	With other users:</b> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.<b />
            ...
            <p>
                ...
                <ul>
                    <li>Email: <a href="mailto:suryaenterprises108@gmail.com">suryaenterprises108@gmail.com</a></li>
                    <li>Website: <a href="https://www.suryaenterprisses.com">www.suryaenterprisses.com</a></li>
                    <li>Phone: 9220489443</li>
                </ul>
            </p>
        </div>
    );
